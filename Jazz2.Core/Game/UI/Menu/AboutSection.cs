...
namespace Jazz2.Game.UI.Menu
{
    public class AboutSection : MainMenuSection
    {
        ...
        public override void OnPaint(Canvas canvas)
        {
            ...
            api.DrawStringShadow(ref charOffset, "(http://deat.tk/)", pos.X + 25f + 70f, pos.Y + 20f + 20f,
                Alignment.Left, ColorRgba.TransparentBlack, 0.7f, 0.4f, 0.6f, 0.6f, 7f, 0.8f);

            float y = pos.Y + 80f;

            api.DrawStringShadow(ref charOffset, "Uses parts of Duality Engine released under MIT/X11 license.", pos.X, y,
