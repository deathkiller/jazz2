...
namespace Duality
{
    ...
    public static class ReflectionHelper
    {
        ...
        public static string GetMemberId(this MemberInfo member)
        {
            ...
            throw new NotSupportedException(string.Format("Member Type '{0} not supported", /*Log.Type(*/member.GetType()/*)*/.ToString()));
        }
            ...
            if (typeNameBase.StartsWith("``")) {
                ...
                if (baseType == null) {
                    ...
                    foreach (Assembly assembly in sortedAsmSearch) {
                        ...
                        try { definedTypes = assembly.DefinedTypes.ToArray(); } catch (Exception) { continue; }
