{
    "Fragment": "
        ...
        void main() {
            ...
            float isTexelBelow = step(waveHeight, vTexcoord0.y - waterLevel);
            ...
            float isNearTop = 1.0 - step(viewSizeInv.y * 2.8, topDist);
            float isVeryNearTop = 1.0 - step(viewSizeInv.y * (0.8 - 100.0 * waveHeight), topDist);

            float topColorBlendFac = isNearTop * isTexelBelow * 0.6;
            main.rgb = mix(main.rgb, texture2D(mainTex, vec2(vTexcoord0.x,
