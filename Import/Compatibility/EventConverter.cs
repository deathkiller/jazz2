        ...
        static EventConverter()
        {
                ...
                switch (eventParams[0]) {
                    ...
                    case 0: { // Normal
                        ...
                        return new ConversionResult {
                            ...
                            eventParams = new ushort[] {255, radiusNear, radiusFar, 0, 0, 0, 0, 0}
                        };
                    }
                    ...
                    case 1: // Single point (ignores the "Size" parameter)
                        return new ConversionResult {
                            eventType = EventType.LightSteady,
                            eventParams = new ushort[] {127, 0, 16, 0, 0, 0, 0, 0}
                        };

                    case 2: // Single point (brighter) (ignores the "Size" parameter)
                        return new ConversionResult {
                            eventType = EventType.LightSteady,
                            eventParams = new ushort[] {255, 0, 16, 0, 0, 0, 0, 0}
                        };
                    ...
                    case 3: { // Flicker light
                        ...
                        return new ConversionResult {
                            ...
                            eventParams = new ushort[] {110, radiusNear, radiusFar, 0, 0, 0, 0, 0}
                        };
                    }
            ...
            convert.Add(JJ2Event.JJ2_LIGHT_PULSE, (level, jj2Params) => {
                ...
                return new ConversionResult {
                    ...
                    eventParams = new ushort[] { 255, radiusNear1, radiusNear2, radiusFar, speed, sync, 0, 0 }
                };
            });
            convert.Add(JJ2Event.JJ2_LIGHT_FLICKER, (level, jj2Params) => {
                ...
                return new ConversionResult {
                    eventType = EventType.LightFlicker,
                    eventParams = new ushort[] { 110, 60, 110, 0, 0, 0, 0, 0 }
                };
            });
            ...
            convert.Add(JJ2Event.JJ2_AMMO_BOUNCER, NoParamList(EventType.AmmoBouncer));
            convert.Add(JJ2Event.JJ2_AMMO_FREEZER, NoParamList(EventType.AmmoFreezer));
            convert.Add(JJ2Event.JJ2_AMMO_SEEKER, NoParamList(EventType.AmmoSeeker));
            convert.Add(JJ2Event.JJ2_AMMO_RF, NoParamList(EventType.AmmoRF));
            convert.Add(JJ2Event.JJ2_AMMO_TOASTER, NoParamList(EventType.AmmoToaster));
            convert.Add(JJ2Event.JJ2_AMMO_TNT, NoParamList(EventType.AmmoTNT));
            convert.Add(JJ2Event.JJ2_AMMO_PEPPER, NoParamList(EventType.AmmoPepper));
            convert.Add(JJ2Event.JJ2_AMMO_ELECTRO, NoParamList(EventType.AmmoElectro));

            convert.Add(JJ2Event.JJ2_FAST_FIRE, NoParamList(EventType.FastFire));
            convert.Add(JJ2Event.JJ2_POWERUP_BLASTER, NoParamList(EventType.PowerUpBlaster));
            convert.Add(JJ2Event.JJ2_POWERUP_BOUNCER, NoParamList(EventType.PowerUpBouncer));
            convert.Add(JJ2Event.JJ2_POWERUP_FREEZER, NoParamList(EventType.PowerUpFreezer));
            convert.Add(JJ2Event.JJ2_POWERUP_SEEKER, NoParamList(EventType.PowerUpSeeker));
            convert.Add(JJ2Event.JJ2_POWERUP_RF, NoParamList(EventType.PowerUpRF));
            convert.Add(JJ2Event.JJ2_POWERUP_TOASTER, NoParamList(EventType.PowerUpToaster));
            convert.Add(JJ2Event.JJ2_POWERUP_TNT, NoParamList(EventType.PowerUpTNT));
            convert.Add(JJ2Event.JJ2_POWERUP_PEPPER, NoParamList(EventType.PowerUpPepper));
            convert.Add(JJ2Event.JJ2_POWERUP_ELECTRO, NoParamList(EventType.PowerUpElectro));

            convert.Add(JJ2Event.JJ2_FOOD_APPLE, NoParamList(EventType.FoodApple));
            convert.Add(JJ2Event.JJ2_FOOD_BANANA, NoParamList(EventType.FoodBanana));
            convert.Add(JJ2Event.JJ2_FOOD_CHERRY, NoParamList(EventType.FoodCherry));
            convert.Add(JJ2Event.JJ2_FOOD_ORANGE, NoParamList(EventType.FoodOrange));
            convert.Add(JJ2Event.JJ2_FOOD_PEAR, NoParamList(EventType.FoodPear));
            convert.Add(JJ2Event.JJ2_FOOD_PRETZEL, NoParamList(EventType.FoodPretzel));
            convert.Add(JJ2Event.JJ2_FOOD_STRAWBERRY, NoParamList(EventType.FoodStrawberry));
            convert.Add(JJ2Event.JJ2_FOOD_LEMON, NoParamList(EventType.FoodLemon));
            convert.Add(JJ2Event.JJ2_FOOD_LIME, NoParamList(EventType.FoodLime));
            convert.Add(JJ2Event.JJ2_FOOD_THING, NoParamList(EventType.FoodThing));
            convert.Add(JJ2Event.JJ2_FOOD_WATERMELON, NoParamList(EventType.FoodWaterMelon));
            convert.Add(JJ2Event.JJ2_FOOD_PEACH, NoParamList(EventType.FoodPeach));
            convert.Add(JJ2Event.JJ2_FOOD_GRAPES, NoParamList(EventType.FoodGrapes));
            convert.Add(JJ2Event.JJ2_FOOD_LETTUCE, NoParamList(EventType.FoodLettuce));
            convert.Add(JJ2Event.JJ2_FOOD_EGGPLANT, NoParamList(EventType.FoodEggplant));
            convert.Add(JJ2Event.JJ2_FOOD_CUCUMBER, NoParamList(EventType.FoodCucumber));
            convert.Add(JJ2Event.JJ2_FOOD_PEPSI, NoParamList(EventType.FoodPepsi));
            convert.Add(JJ2Event.JJ2_FOOD_COKE, NoParamList(EventType.FoodCoke));
            convert.Add(JJ2Event.JJ2_FOOD_MILK, NoParamList(EventType.FoodMilk));
            convert.Add(JJ2Event.JJ2_FOOD_PIE, NoParamList(EventType.FoodPie));
            convert.Add(JJ2Event.JJ2_FOOD_CAKE, NoParamList(EventType.FoodCake));
            convert.Add(JJ2Event.JJ2_FOOD_DONUT, NoParamList(EventType.FoodDonut));
            convert.Add(JJ2Event.JJ2_FOOD_CUPCAKE, NoParamList(EventType.FoodCupcake));
            convert.Add(JJ2Event.JJ2_FOOD_CHIPS, NoParamList(EventType.FoodChips));
            convert.Add(JJ2Event.JJ2_FOOD_CANDY, NoParamList(EventType.FoodCandy));
            convert.Add(JJ2Event.JJ2_FOOD_CHOCOLATE, NoParamList(EventType.FoodChocolate));
            convert.Add(JJ2Event.JJ2_FOOD_ICE_CREAM, NoParamList(EventType.FoodIceCream));
            convert.Add(JJ2Event.JJ2_FOOD_BURGER, NoParamList(EventType.FoodBurger));
            convert.Add(JJ2Event.JJ2_FOOD_PIZZA, NoParamList(EventType.FoodPizza));
            convert.Add(JJ2Event.JJ2_FOOD_FRIES, NoParamList(EventType.FoodFries));
            convert.Add(JJ2Event.JJ2_FOOD_CHICKEN_LEG, NoParamList(EventType.FoodChickenLeg));
            convert.Add(JJ2Event.JJ2_FOOD_SANDWICH, NoParamList(EventType.FoodSandwich));
            convert.Add(JJ2Event.JJ2_FOOD_TACO, NoParamList(EventType.FoodTaco));
            convert.Add(JJ2Event.JJ2_FOOD_HOT_DOG, NoParamList(EventType.FoodHotDog));
            convert.Add(JJ2Event.JJ2_FOOD_HAM, NoParamList(EventType.FoodHam));
            convert.Add(JJ2Event.JJ2_FOOD_CHEESE, NoParamList(EventType.FoodCheese));
