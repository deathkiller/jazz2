...
namespace Jazz2.Compatibility
{
    public class EventConverter
    {
        ...
        private static void AddDefaultConverters()
        {
            ...
            Add(JJ2Event.FOOD_APPLE, ConstantParamList(EventType.Food, (ushort)FoodType.Apple));
            Add(JJ2Event.FOOD_BANANA, ConstantParamList(EventType.Food, (ushort)FoodType.Banana));
            Add(JJ2Event.FOOD_CHERRY, ConstantParamList(EventType.Food, (ushort)FoodType.Cherry));
            Add(JJ2Event.FOOD_ORANGE, ConstantParamList(EventType.Food, (ushort)FoodType.Orange));
            Add(JJ2Event.FOOD_PEAR, ConstantParamList(EventType.Food, (ushort)FoodType.Pear));
            Add(JJ2Event.FOOD_PRETZEL, ConstantParamList(EventType.Food, (ushort)FoodType.Pretzel));
            Add(JJ2Event.FOOD_STRAWBERRY, ConstantParamList(EventType.Food, (ushort)FoodType.Strawberry));
            Add(JJ2Event.FOOD_LEMON, ConstantParamList(EventType.Food, (ushort)FoodType.Lemon));
            Add(JJ2Event.FOOD_LIME, ConstantParamList(EventType.Food, (ushort)FoodType.Lime));
            Add(JJ2Event.FOOD_THING, ConstantParamList(EventType.Food, (ushort)FoodType.Thing));
            Add(JJ2Event.FOOD_WATERMELON, ConstantParamList(EventType.Food, (ushort)FoodType.WaterMelon));
            Add(JJ2Event.FOOD_PEACH, ConstantParamList(EventType.Food, (ushort)FoodType.Peach));
            Add(JJ2Event.FOOD_GRAPES, ConstantParamList(EventType.Food, (ushort)FoodType.Grapes));
            Add(JJ2Event.FOOD_LETTUCE, ConstantParamList(EventType.Food, (ushort)FoodType.Lettuce));
            Add(JJ2Event.FOOD_EGGPLANT, ConstantParamList(EventType.Food, (ushort)FoodType.Eggplant));
            Add(JJ2Event.FOOD_CUCUMBER, ConstantParamList(EventType.Food, (ushort)FoodType.Cucumber));
            Add(JJ2Event.FOOD_PEPSI, ConstantParamList(EventType.Food, (ushort)FoodType.Pepsi));
            Add(JJ2Event.FOOD_COKE, ConstantParamList(EventType.Food, (ushort)FoodType.Coke));
            Add(JJ2Event.FOOD_MILK, ConstantParamList(EventType.Food, (ushort)FoodType.Milk));
            Add(JJ2Event.FOOD_PIE, ConstantParamList(EventType.Food, (ushort)FoodType.Pie));
            Add(JJ2Event.FOOD_CAKE, ConstantParamList(EventType.Food, (ushort)FoodType.Cake));
            Add(JJ2Event.FOOD_DONUT, ConstantParamList(EventType.Food, (ushort)FoodType.Donut));
            Add(JJ2Event.FOOD_CUPCAKE, ConstantParamList(EventType.Food, (ushort)FoodType.Cupcake));
            Add(JJ2Event.FOOD_CHIPS, ConstantParamList(EventType.Food, (ushort)FoodType.Chips));
            Add(JJ2Event.FOOD_CANDY, ConstantParamList(EventType.Food, (ushort)FoodType.Candy));
            Add(JJ2Event.FOOD_CHOCOLATE, ConstantParamList(EventType.Food, (ushort)FoodType.Chocolate));
            Add(JJ2Event.FOOD_ICE_CREAM, ConstantParamList(EventType.Food, (ushort)FoodType.IceCream));
            Add(JJ2Event.FOOD_BURGER, ConstantParamList(EventType.Food, (ushort)FoodType.Burger));
            Add(JJ2Event.FOOD_PIZZA, ConstantParamList(EventType.Food, (ushort)FoodType.Pizza));
            Add(JJ2Event.FOOD_FRIES, ConstantParamList(EventType.Food, (ushort)FoodType.Fries));
            Add(JJ2Event.FOOD_CHICKEN_LEG, ConstantParamList(EventType.Food, (ushort)FoodType.ChickenLeg));
            Add(JJ2Event.FOOD_SANDWICH, ConstantParamList(EventType.Food, (ushort)FoodType.Sandwich));
            Add(JJ2Event.FOOD_TACO, ConstantParamList(EventType.Food, (ushort)FoodType.Taco));
            Add(JJ2Event.FOOD_HOT_DOG, ConstantParamList(EventType.Food, (ushort)FoodType.HotDog));
            Add(JJ2Event.FOOD_HAM, ConstantParamList(EventType.Food, (ushort)FoodType.Ham));
            Add(JJ2Event.FOOD_CHEESE, ConstantParamList(EventType.Food, (ushort)FoodType.Cheese));
