    ...
    public class NativeTexture : INativeTexture
    {
        ...
        unsafe void INativeTexture.LoadData(TexturePixelFormat format, int width, int height, IntPtr data, ColorDataLayout dataLayout, ColorDataElementType dataElementType)
        {
            ...
            GraphicsBackend.GL.TexImage2D(WebGLRenderingContextBase.TEXTURE_2D, 0,
                ...
                TypedArray<Uint8Array, byte>.From(new Span<byte>(data.ToPointer(), /*ToDo*/(width * height * 4))));
        ...
        void IDisposable.Dispose()
        {
            if (DualityApp.ExecContext != DualityApp.ExecutionContext.Terminated &&
                ...
                try {
                    ...
                    Console.WriteLine("DeleteTexture() failed: " + this.handle + " | " + ex);
                }
        ...
        {
            switch (format) {
                //case TexturePixelFormat.Single: return WebGLRenderingContextBase.R8;
                //case TexturePixelFormat.Dual: return WebGLRenderingContextBase.RG8;
                case TexturePixelFormat.Rgb: return WebGLRenderingContextBase.RGB;
                default:
                case TexturePixelFormat.Rgba: return WebGLRenderingContextBase.RGBA;

                //case TexturePixelFormat.FloatSingle: return WebGLRenderingContextBase.R16F;
                //case TexturePixelFormat.FloatDual: return WebGLRenderingContextBase.RG16F;
                //case TexturePixelFormat.FloatRgb: return WebGLRenderingContextBase.RGB16F;
                //case TexturePixelFormat.FloatRgba: return WebGLRenderingContextBase.RGBA16F;
        ...
        {
            switch (format) {
                //case TexturePixelFormat.Single: return WebGLRenderingContextBase.RED;
                //case TexturePixelFormat.Dual: return WebGLRenderingContextBase.RG;
                case TexturePixelFormat.Rgb: return WebGLRenderingContextBase.RGB;
                default:
                case TexturePixelFormat.Rgba: return WebGLRenderingContextBase.RGBA;

                //case TexturePixelFormat.FloatSingle: return WebGLRenderingContextBase.RED;
                //case TexturePixelFormat.FloatDual: return WebGLRenderingContextBase.RG;
                //case TexturePixelFormat.FloatRgb: return WebGLRenderingContextBase.RGB;
                //case TexturePixelFormat.FloatRgba: return WebGLRenderingContextBase.RGBA;
